...
cartodb.createVis('map', 'https://kyeah.cartodb.com/api/v2/viz/6f8589b6-2f5a-11e5-b4e8-0e9d821ea90d/viz.json')
    .on('done', function(map, layers) {
        ...
        sublayer.setSQL(clusterSQLpre + "SELECT * FROM hlcp_2" + clusterSQLpost);
...
$('.button').click(function() {
    ...
    console.log(checked);
    sublayers[0].setSQL(clusterSQLpre + "SELECT * FROM hlcp_2 WHERE date LIKE (" + checked.join() + ")" + clusterSQLpost);
    return true;
});
